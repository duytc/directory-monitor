...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'monolog.logger.pheanstalk' => 'getMonolog_Logger_PheanstalkService',
            ...
            'tagcade_app.repository.imported_file' => 'getTagcadeApp_Repository_ImportedFileService',
            'tagcade_app.repository.queued_file' => 'getTagcadeApp_Repository_QueuedFileService',
        ...
        $this->aliases = array(
            'console.command.leezy_pheanstalkbundle_command_deletejobcommand' => 'leezy.pheanstalk.command.delete_job',
            'console.command.leezy_pheanstalkbundle_command_flushtubecommand' => 'leezy.pheanstalk.command.flush_tube',
            'console.command.leezy_pheanstalkbundle_command_kickcommand' => 'leezy.pheanstalk.command.kick',
            'console.command.leezy_pheanstalkbundle_command_kickjobcommand' => 'leezy.pheanstalk.command.kick_job',
            'console.command.leezy_pheanstalkbundle_command_listtubecommand' => 'leezy.pheanstalk.command.list_tube',
            'console.command.leezy_pheanstalkbundle_command_nextreadycommand' => 'leezy.pheanstalk.command.next_ready',
            'console.command.leezy_pheanstalkbundle_command_pausetubecommand' => 'leezy.pheanstalk.command.pause_tube',
            'console.command.leezy_pheanstalkbundle_command_peekcommand' => 'leezy.pheanstalk.command.peek',
            'console.command.leezy_pheanstalkbundle_command_peektubecommand' => 'leezy.pheanstalk.command.peek_tube',
            'console.command.leezy_pheanstalkbundle_command_putcommand' => 'leezy.pheanstalk.command.put',
            'console.command.leezy_pheanstalkbundle_command_statscommand' => 'leezy.pheanstalk.command.stats',
            'console.command.leezy_pheanstalkbundle_command_statsjobcommand' => 'leezy.pheanstalk.command.stats_job',
            'console.command.leezy_pheanstalkbundle_command_statstubecommand' => 'leezy.pheanstalk.command.stats_tube',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tagcade_unified_report', 'user' => 'tagcadedev', 'password' => 'tagcadedev', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array('enum' => 'string'));
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Tagcade/Resources/config/doctrine/Core') => 'Tagcade\\Entity\\Core'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Tagcade\\Entity\\Core');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('TagcadeCoreEntity' => 'Tagcade\\Entity\\Core'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7be97bd00cf4e00547dbe27253299ce9195e940db845f25f3f6e51c0a7d82a9a');
    ...
    /**
     * Gets the 'leezy.pheanstalk.command.delete_job' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\DeleteJobCommand A Leezy\PheanstalkBundle\Command\DeleteJobCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_DeleteJobService()
    {
        return $this->services['leezy.pheanstalk.command.delete_job'] = new \Leezy\PheanstalkBundle\Command\DeleteJobCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.flush_tube' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\FlushTubeCommand A Leezy\PheanstalkBundle\Command\FlushTubeCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_FlushTubeService()
    {
        return $this->services['leezy.pheanstalk.command.flush_tube'] = new \Leezy\PheanstalkBundle\Command\FlushTubeCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.kick' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\KickCommand A Leezy\PheanstalkBundle\Command\KickCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_KickService()
    {
        return $this->services['leezy.pheanstalk.command.kick'] = new \Leezy\PheanstalkBundle\Command\KickCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.kick_job' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\KickJobCommand A Leezy\PheanstalkBundle\Command\KickJobCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_KickJobService()
    {
        return $this->services['leezy.pheanstalk.command.kick_job'] = new \Leezy\PheanstalkBundle\Command\KickJobCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.list_tube' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\ListTubeCommand A Leezy\PheanstalkBundle\Command\ListTubeCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_ListTubeService()
    {
        return $this->services['leezy.pheanstalk.command.list_tube'] = new \Leezy\PheanstalkBundle\Command\ListTubeCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.next_ready' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\NextReadyCommand A Leezy\PheanstalkBundle\Command\NextReadyCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_NextReadyService()
    {
        return $this->services['leezy.pheanstalk.command.next_ready'] = new \Leezy\PheanstalkBundle\Command\NextReadyCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.pause_tube' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\PauseTubeCommand A Leezy\PheanstalkBundle\Command\PauseTubeCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_PauseTubeService()
    {
        return $this->services['leezy.pheanstalk.command.pause_tube'] = new \Leezy\PheanstalkBundle\Command\PauseTubeCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.peek' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\PeekCommand A Leezy\PheanstalkBundle\Command\PeekCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_PeekService()
    {
        return $this->services['leezy.pheanstalk.command.peek'] = new \Leezy\PheanstalkBundle\Command\PeekCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.peek_tube' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\PeekTubeCommand A Leezy\PheanstalkBundle\Command\PeekTubeCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_PeekTubeService()
    {
        return $this->services['leezy.pheanstalk.command.peek_tube'] = new \Leezy\PheanstalkBundle\Command\PeekTubeCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.put' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\PutCommand A Leezy\PheanstalkBundle\Command\PutCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_PutService()
    {
        return $this->services['leezy.pheanstalk.command.put'] = new \Leezy\PheanstalkBundle\Command\PutCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.stats' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\StatsCommand A Leezy\PheanstalkBundle\Command\StatsCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_StatsService()
    {
        return $this->services['leezy.pheanstalk.command.stats'] = new \Leezy\PheanstalkBundle\Command\StatsCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.stats_job' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\StatsJobCommand A Leezy\PheanstalkBundle\Command\StatsJobCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_StatsJobService()
    {
        return $this->services['leezy.pheanstalk.command.stats_job'] = new \Leezy\PheanstalkBundle\Command\StatsJobCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }

    /**
     * Gets the 'leezy.pheanstalk.command.stats_tube' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Leezy\PheanstalkBundle\Command\StatsTubeCommand A Leezy\PheanstalkBundle\Command\StatsTubeCommand instance.
     */
    protected function getLeezy_Pheanstalk_Command_StatsTubeService()
    {
        return $this->services['leezy.pheanstalk.command.stats_tube'] = new \Leezy\PheanstalkBundle\Command\StatsTubeCommand($this->get('leezy.pheanstalk.pheanstalk_locator'));
    }
    ...
    protected function getLeezy_Pheanstalk_Listener_LogService()
    {
        ...
        if ($this->has('monolog.logger.pheanstalk')) {
            $instance->setLogger($this->get('monolog.logger.pheanstalk', ContainerInterface::NULL_ON_INVALID_REFERENCE));
        }
    ...
    protected function getLeezy_Pheanstalk_PheanstalkLocatorService()
    {
        ...
        $a->setPheanstalk(new \Pheanstalk\Pheanstalk('127.0.0.1', '11300', '60'));
        $a->setName('primary');
    ...
    protected function getLeezy_Pheanstalk_PrimaryService()
    {
        ...
        $instance->setPheanstalk(new \Pheanstalk\Pheanstalk('127.0.0.1', '11300', '60'));
    ...
    /**
     * Gets the 'monolog.logger.pheanstalk' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bridge\Monolog\Logger A Symfony\Bridge\Monolog\Logger instance.
     */
    protected function getMonolog_Logger_PheanstalkService()
    {
        $this->services['monolog.logger.pheanstalk'] = $instance = new \Symfony\Bridge\Monolog\Logger('pheanstalk');
    ...
    /**
     * Gets the 'tagcade_app.repository.imported_file' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tagcade\Repository\Core\ImportedFileRepository A Tagcade\Repository\Core\ImportedFileRepository instance.
     */
    protected function getTagcadeApp_Repository_ImportedFileService()
    {
        return $this->services['tagcade_app.repository.imported_file'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('Tagcade\\Entity\\Core\\ImportedFile');
    }

    /**
     * Gets the 'tagcade_app.repository.queued_file' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tagcade\Repository\Core\ImportedFileRepository A Tagcade\Repository\Core\ImportedFileRepository instance.
     */
    protected function getTagcadeApp_Repository_QueuedFileService()
    {
        return $this->services['tagcade_app.repository.queued_file'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('Tagcade\\Entity\\Core\\QueuedFile');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TagcadeAppBundle' => 'Tagcade\\Bundle\\AppBundle\\TagcadeAppBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'tagcade_unified_report',
            'database_user' => 'tagcadedev',
            'database_password' => 'tagcadedev',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'watch_root' => '/home/vagrant/tagcade/directory-monitor/data',
            'pheanstalk_ttr' => 60,
            'pheanstalk_files_tube' => 'unified-report-files',
            'locale' => 'en',
            ...
            'tagcade.entity.queued_file.class' => 'Tagcade\\Entity\\Core\\QueuedFile',
            ...
            'leezy.pheanstalk.command.abstract.class' => 'Leezy\\PheanstalkBundle\\Command\\AbstractPheanstalkCommand',
            'leezy.pheanstalk.command.delete_job.class' => 'Leezy\\PheanstalkBundle\\Command\\DeleteJobCommand',
            'leezy.pheanstalk.command.flush_tube.class' => 'Leezy\\PheanstalkBundle\\Command\\FlushTubeCommand',
            'leezy.pheanstalk.command.kick.class' => 'Leezy\\PheanstalkBundle\\Command\\KickCommand',
            'leezy.pheanstalk.command.kick_job.class' => 'Leezy\\PheanstalkBundle\\Command\\KickJobCommand',
            'leezy.pheanstalk.command.list_tube.class' => 'Leezy\\PheanstalkBundle\\Command\\ListTubeCommand',
            'leezy.pheanstalk.command.next_ready.class' => 'Leezy\\PheanstalkBundle\\Command\\NextReadyCommand',
            'leezy.pheanstalk.command.pause_tube.class' => 'Leezy\\PheanstalkBundle\\Command\\PauseTubeCommand',
            'leezy.pheanstalk.command.peek.class' => 'Leezy\\PheanstalkBundle\\Command\\PeekCommand',
            'leezy.pheanstalk.command.peek_tube.class' => 'Leezy\\PheanstalkBundle\\Command\\PeekTubeCommand',
            'leezy.pheanstalk.command.put.class' => 'Leezy\\PheanstalkBundle\\Command\\PutCommand',
            'leezy.pheanstalk.command.stats.class' => 'Leezy\\PheanstalkBundle\\Command\\StatsCommand',
            'leezy.pheanstalk.command.stats_job.class' => 'Leezy\\PheanstalkBundle\\Command\\StatsJobCommand',
            'leezy.pheanstalk.command.stats_tube.class' => 'Leezy\\PheanstalkBundle\\Command\\StatsTubeCommand',
            ...
            'console.command.ids' => array(
                0 => 'leezy.pheanstalk.command.delete_job',
                1 => 'leezy.pheanstalk.command.flush_tube',
                2 => 'leezy.pheanstalk.command.kick',
                3 => 'leezy.pheanstalk.command.kick_job',
                4 => 'leezy.pheanstalk.command.list_tube',
                5 => 'leezy.pheanstalk.command.next_ready',
                6 => 'leezy.pheanstalk.command.pause_tube',
                7 => 'leezy.pheanstalk.command.peek',
                8 => 'leezy.pheanstalk.command.peek_tube',
                9 => 'leezy.pheanstalk.command.put',
                10 => 'leezy.pheanstalk.command.stats',
                11 => 'leezy.pheanstalk.command.stats_job',
                12 => 'leezy.pheanstalk.command.stats_tube',
